...
```
This project was completed as part of the Google Data Analytics Capstone to explore user behavior and membership conversion strategies for Cyclistic Bike Share.
...
## Primary Questions: 1.
How do trip durations differ by rider type?
2.
How do ride volumes vary by day and hour?
3.
Which start stations are most used by each segment?
